...
payload = {"title": "Fix for issue #87", "body": "Closes #87\n\nImplemented automated fix.", "head": "KartavyaDikshit:fix-issue-87", "base": "main"}
req = urllib.request.Request("https://api.github.com/repos/AcademySoftwareFoundation/dna/pulls", data=json.dumps(payload).encode(), headers={'Authorization': f'token {token}', 'Accept': 'application/vnd.github.v3+json', 'Content-Type': 'application/json'}, method='POST')
try:
