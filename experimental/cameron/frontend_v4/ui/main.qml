...
ApplicationWindow {
    ...
    height: 800
    minimumWidth: {
        // With left sidebar for widgets + versions list + notes
        if (versionsListVisible) return 770
        // If only icon sidebar and notes section, minimum is 520
        return 520
    }
    minimumHeight: 750
    ...
    property int iconSidebarWidth: 70

    // Widget overlay visibility
    property bool meetingOverlayVisible: false
    property bool llmOverlayVisible: false
    property bool playlistsOverlayVisible: false
    ...
    // Keyboard shortcut to toggle Meeting widget
    Shortcut {
        sequence: "Ctrl+Shift+M"
        context: Qt.ApplicationShortcut
        onActivated: {
            meetingOverlayVisible = !meetingOverlayVisible
        }
    }

    // Keyboard shortcut to toggle LLM widget
    Shortcut {
        sequence: "Ctrl+Shift+L"
        context: Qt.ApplicationShortcut
        onActivated: {
            llmOverlayVisible = !llmOverlayVisible
        }
    }

    // Keyboard shortcut to toggle Playlists widget
    Shortcut {
        sequence: "Ctrl+Shift+P"
        context: Qt.ApplicationShortcut
        onActivated: {
            playlistsOverlayVisible = !playlistsOverlayVisible
        }
    }
    ...
    menuBar: MenuBar {
        ...
        Menu {
            ...
            MenuItem {
                text: meetingOverlayVisible ? "Hide Meeting Widget" : "Show Meeting Widget"
                onTriggered: meetingOverlayVisible = !meetingOverlayVisible
            }

            MenuItem {
                text: llmOverlayVisible ? "Hide LLM Widget" : "Show LLM Widget"
                onTriggered: llmOverlayVisible = !llmOverlayVisible
            }

            MenuItem {
                text: playlistsOverlayVisible ? "Hide Playlists Widget" : "Show Playlists Widget"
                onTriggered: playlistsOverlayVisible = !playlistsOverlayVisible
            }
    ...
    RowLayout {
        ...
        // Left Icon Sidebar
        Rectangle {
            Layout.preferredWidth: iconSidebarWidth
            ...
            ColumnLayout {
                ...
                Image {
                    ...
                    source: "../img/dna_side.png"
                    fillMode: Image.PreserveAspectFit
                }

                Item { Layout.fillHeight: true }

                // Playlists Icon Button
                Button {
                    Layout.alignment: Qt.AlignHCenter
                    Layout.preferredWidth: 54
                    Layout.preferredHeight: 54
                    ...
                    onClicked: {
                        playlistsOverlayVisible = true
                    }

                    background: Rectangle {
                        color: playlistsOverlayVisible ? themeManager.accentColor : (parent.hovered ? "#3a3a3a" : "transparent")
                        radius: 8
                        border.color: parent.hovered ? themeManager.borderColor : "transparent"
                        border.width: 1
                    }
                    ...
                    ToolTip.text: "Playlists (Ctrl+Shift+P)"
                    ToolTip.delay: 500
                }
                ...
                Button {
                    ...
                    onClicked: {
                        meetingOverlayVisible = true
                    }

                    background: Rectangle {
                        color: meetingOverlayVisible ? themeManager.accentColor : (parent.hovered ? "#3a3a3a" : "transparent")
                        radius: 8
                        border.color: parent.hovered ? themeManager.borderColor : "transparent"
                        border.width: 1
                    }
                    ...
                    ToolTip.visible: hovered
                    ToolTip.text: "Meeting (Ctrl+Shift+M)"
                    ToolTip.delay: 500
                }
                ...
                Button {
                    ...
                    onClicked: {
                        llmOverlayVisible = true
                    }

                    background: Rectangle {
                        color: llmOverlayVisible ? themeManager.accentColor : (parent.hovered ? "#3a3a3a" : "transparent")
                        radius: 8
                        border.color: parent.hovered ? themeManager.borderColor : "transparent"
                        border.width: 1
                    }
                    ...
                    ToolTip.visible: hovered
                    ToolTip.text: "LLM Assistant (Ctrl+Shift+L)"
                    ToolTip.delay: 500
                }
                ...
                Button {
                    ...
                    ToolTip.visible: hovered
                    ToolTip.text: "Settings (Ctrl+Shift+S)"
                    ToolTip.delay: 500
                }
            }
        }
                        ...
                        Item {
                            ...
                            ListView {
                                ...
                                delegate: ItemDelegate {
                                    width: versionListView.width - 16
                    ...
                    SplitView {
                        ...
                        Rectangle {
                            ...
                            Button {
                                ...
                                ToolTip.visible: hovered
                                ToolTip.text: notesEntryContainer.markdownPreview ? "Show raw Markdown (Ctrl+Shift+K)" : "Preview rendered Markdown (Ctrl+Shift+K)"
                                ToolTip.delay: 500
                            }
                ...
                ScrollView {
                    ...
                    ColumnLayout {
                        ...
                        GridLayout {
                            ...
                            // Toggle Meeting Widget
                            Text {
                                text: "Toggle Meeting Widget:"
                                font.pixelSize: 12
                                color: themeManager.textColor
                                Layout.alignment: Qt.AlignRight
                            }
                            ...
                            // Toggle Playlists Widget
                            Text {
                                text: "Toggle Playlists Widget:"
                                font.pixelSize: 12
                                color: themeManager.textColor
                                Layout.alignment: Qt.AlignRight
                            }
    ...
    Rectangle {
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: meetingOverlayVisible = false
        }
        ...
        Rectangle {
            ...
            MouseArea {
                anchors.fill: parent
                onClicked: {} // Prevent clicks from closing dialog
            }
            ...
            ColumnLayout {
                ...
                TextField {
                    ...
                    onTextChanged: backend.meetingId = text
                }
                    ...
                    Button {
                        ...
                        background: Rectangle {
                            color: {
                                ...
                                if (parent.isPaused) {
                                    return parent.hovered ? "#28a745" : "#4caf50"
                                } else {
                                    return parent.hovered ? "#d4a500" : "#ffc107"
                                }
                            }
                            radius: 4
                        }
                    ...
                    onClicked: {
                        if (backend.meetingActive) {
                            ...
                            if (!backend.vexaApiKey) {
                                warningDialog.warningMessage = "Please add your Vexa API key in Preferences to join meetings."
                                warningDialog.open()
                            } else {
                                backend.joinMeeting()
                            }
    ...
    // LLM Assistant Widget Overlay
    Rectangle {
        anchors.fill: parent
        color: "#80000000"
        visible: llmOverlayVisible
        z: 1000

        MouseArea {
            anchors.fill: parent
            onClicked: llmOverlayVisible = false
        }
    ...
    // Playlists Widget Overlay
    Rectangle {
        anchors.fill: parent
        color: "#80000000"
        visible: playlistsOverlayVisible
        z: 1000

        MouseArea {
            anchors.fill: parent
            onClicked: playlistsOverlayVisible = false
        }

        Rectangle {
            anchors.centerIn: parent
            width: Math.min(650, root.width - 100)
                    ...
                    ColumnLayout {
                            ...
                            onPressedChanged: {
                                if (pressed) {
                                    if (!backend.shotgridUrl || !backend.shotgridApiKey || !backend.shotgridScriptName) {
                                        warningDialog.warningMessage = "Please add complete ShotGrid integration information in Preferences."
                                        warningDialog.open()
                        ...
                        Button {
                            ...
                            onPressedChanged: {
                                if (pressed && !enabled) {
                                    if (!backend.shotgridUrl || !backend.shotgridApiKey || !backend.shotgridScriptName) {
                                        warningDialog.warningMessage = "Please configure ShotGrid credentials in Preferences before syncing."
                                        warningDialog.open()
